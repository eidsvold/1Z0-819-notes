...
* The _StringBuilder_ method _delete_ removes characters from index inclusive to index exclusive, e.g. ```StringBuilder builder = new StringBuilder("ABCDE").delete(1, 2);``` removes ```B``` only from the builder object.
